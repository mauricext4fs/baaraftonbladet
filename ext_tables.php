...
(static function() {
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        ...
        '',
        [
            \Mauricext4fs\Baaraftonbladet\Controller\NyheterController::class => 'list, show, new, create, edit, update, downloadcsv, delete',
            \Mauricext4fs\Baaraftonbladet\Controller\TagController::class => 'list, show, new, create, edit, update, downloadcsv, delete',
